...
#id  = GaP
%const bohr=0.529177 a=5.4505/bohr
STRUC
     ALAT={a} 
...
SITE
     ...
     ATOM=P POS=0.25 0.25 0.25
SPEC
    ATOM=Ga Z=31 R=2.14 PZ=0,0,3.9  P=0,0,4.5 
      EH=-1 -1 -1 -1  RSMH=1.07 1.07 1.07 1.07 
      EH2=-2 -2 -2  RSMH2=1.07 1.07 1.07 
    ...
    ATOM=P Z=15 R=2.19    
      EH=-1 -1 -1 -1  RSMH=1.09 1.09 1.09 1.09 
      EH2=-2 -2 -2  RSMH2=1.09 1.09 1.09 
      KMXA={kmxa}  LMX=3 LMXA=4 NMCORE=1
      #MMOM=0 0 1 0 #s,p,d,f initial condition
      #NOTE: lmfa(rhocor) generates spin-averaged rho for any MMOM,jun2012
      #Q=0 0.5 1 0 #s,p,d,f initial condition 
